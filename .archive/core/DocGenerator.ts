...
export class DocGenerator {
  ...
  public async generateDocumentation(
    ...
    try {
      ...
      Logger.warning(`AI generation failed for ${sourceFile}, using fallback`)
  ...
  private async buildProjectContext(sourceFile: string): Promise<ProjectContext> {
    ...
    try {
      ...
      Logger.warning('Error building project context')
  ...
  private async analyzeProjectStructure(projectRoot: string): Promise<FileStructureInfo[]> {
    ...
    try {
      ...
      Logger.warning('Error analyzing project structure')
    }
  ...
  private async walkDirectory(
    ...
    try {
      ...
      Logger.warning(`Error walking directory ${dirPath}`)
    }
  }
  ...
  private async readSourceFile(sourceFile: string): Promise<string> {
    try {
      ...
      Logger.warning(`Could not read source file ${sourceFile}`)
      return ''
    }
  }
